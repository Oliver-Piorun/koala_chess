...
impl Game {
    pub fn new(shader: Shader, atlas_shader: Shader, aspect_ratio: f32) -> Game {
        ...
        for board_x in 0..8 {
            ...
            #[rustfmt::skip]
            let black_pawn = Piece::new(PieceColor::Black, PieceKind::Pawn, board_x, 6, atlas_shader, aspect_ratio);
        ...
        #[rustfmt::skip]
        let left_black_rook = Piece::new(PieceColor::Black, PieceKind::Rook, 0, 7, atlas_shader, aspect_ratio);
        #[rustfmt::skip]
        let right_black_rook = Piece::new(PieceColor::Black, PieceKind::Rook, 7, 7, atlas_shader, aspect_ratio);
        ...
        #[rustfmt::skip]
        let left_black_knight = Piece::new(PieceColor::Black, PieceKind::Knight, 1, 7, atlas_shader, aspect_ratio);
        #[rustfmt::skip]
        let right_black_knight = Piece::new(PieceColor::Black, PieceKind::Knight, 6, 7, atlas_shader, aspect_ratio);
        ...
        #[rustfmt::skip]
        let left_black_bishop = Piece::new(PieceColor::Black, PieceKind::Bishop, 2, 7, atlas_shader, aspect_ratio);
        #[rustfmt::skip]
        let right_black_bishop = Piece::new(PieceColor::Black, PieceKind::Bishop, 5, 7, atlas_shader, aspect_ratio);

        #[rustfmt::skip]
        let white_queen = Piece::new(PieceColor::White, PieceKind::Queen, 3, 0, atlas_shader, aspect_ratio);
        #[rustfmt::skip]
        let black_queen = Piece::new(PieceColor::Black, PieceKind::Queen, 3, 7, atlas_shader, aspect_ratio);

        #[rustfmt::skip]
        let white_king = Piece::new(PieceColor::White, PieceKind::King, 4, 0, atlas_shader, aspect_ratio);
        #[rustfmt::skip]
        let black_king = Piece::new(PieceColor::Black, PieceKind::King, 4, 7, atlas_shader, aspect_ratio);
